// Command RandomFox-cli is a CLI + REPL for the RandomFox SDK,
...
const prompt = "random-fox"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "fox"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      RANDOM_FOX_APIKEY (api key), RANDOM_FOX_BASE (base url override)")
