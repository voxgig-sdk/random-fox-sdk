...
func registerSDKWords(r *eng.Registry, client *sdk.RandomFoxSDK) {
...
func runOp(client *sdk.RandomFoxSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
