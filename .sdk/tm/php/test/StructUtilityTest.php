...
// RandomFox SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RandomFoxOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RandomFoxOmni::structfix($now, Struct::undef()))
                        !== json_encode(RandomFoxOmni::structfix($val, Struct::undef()))) {
