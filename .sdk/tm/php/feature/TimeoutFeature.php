...
class RandomFoxTimeoutFeature extends RandomFoxBaseFeature
{
    ...
    private function _with_timeout(RandomFoxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RandomFoxContext $_ctx, float $ms): void
    {
        $client = $this->client;
