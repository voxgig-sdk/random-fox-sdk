...
class RandomFoxRbacFeature extends RandomFoxBaseFeature
{
    ...
    private function _required(RandomFoxContext $ctx): ?string
    {
    ...
    private function _reject(RandomFoxContext $ctx, string $required): void
    {
    ...
    private function _track(RandomFoxContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
