...
// RandomFox SDK ratelimit feature
...
class RandomFoxRatelimitFeature extends RandomFoxBaseFeature
{
    ...
    private function _acquire(RandomFoxContext $ctx): void
    {
    ...
    private function _track(RandomFoxContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
