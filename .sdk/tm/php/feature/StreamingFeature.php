...
// RandomFox SDK streaming feature
...
class RandomFoxStreamingFeature extends RandomFoxBaseFeature
{
    ...
    private function _iterate(RandomFoxResult $result): \Generator
    {
    ...
    private function _streamable(RandomFoxContext $ctx): bool
    {
