...
// RandomFox SDK clienttrack feature
...
class RandomFoxClienttrackFeature extends RandomFoxBaseFeature
{
    ...
    public function PostConstruct(RandomFoxContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RandomFox-SDK';
