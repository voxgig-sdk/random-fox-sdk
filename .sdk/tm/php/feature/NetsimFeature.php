...
class RandomFoxNetsimFeature extends RandomFoxBaseFeature
{
    ...
    private function _simulate(RandomFoxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RandomFoxContext $ctx, array $applied): void
    {
        $client = $this->client;
