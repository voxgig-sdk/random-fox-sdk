...
class RandomFoxCacheFeature extends RandomFoxBaseFeature
{
    ...
    private function _through(RandomFoxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
