...
// RandomFox SDK utility: fetcher

class RandomFoxFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RandomFoxSDK/1.0)';
    ...
    public static function call(RandomFoxContext $ctx, string $fullurl, array $fetchdef): array
    {
