...
class RandomFoxGraphql
{
    ...
    // equivalent.
    public static function body(RandomFoxContext $ctx): mixed
    {
    ...
    public static function errors(RandomFoxContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
