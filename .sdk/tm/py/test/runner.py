...
class RandomFoxTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RandomFoxTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = RandomFoxTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = RandomFoxTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
