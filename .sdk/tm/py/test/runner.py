...
class RandomFoxTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RandomFoxTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = RandomFoxTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = RandomFoxTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
