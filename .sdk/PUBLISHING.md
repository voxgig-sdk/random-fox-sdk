...
|---|---|---|
| `ts/` | @voxgig-sdk/random-fox-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/random-fox-sdk \
      --repository voxgig-sdk/random-fox-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/random-fox-sdk` shows it, and
`npm trust revoke @voxgig-sdk/random-fox-sdk --id=<id>` removes it.
