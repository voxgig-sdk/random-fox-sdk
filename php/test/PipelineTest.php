...
{
    private static function utility(): RandomFoxUtility
    {
        return new RandomFoxUtility();
    }
    ...
    private static function ctx(array $over = []): RandomFoxContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RandomFoxContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RandomFoxOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RandomFoxError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RandomFoxOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RandomFoxMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RandomFoxOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RandomFoxMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RandomFoxOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RandomFoxMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RandomFoxSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RandomFoxMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RandomFoxResponse([]),
            'result' => new RandomFoxResult([]),
        ]);
        [, $err] = RandomFoxMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RandomFoxSpec([]),
            'response' => null,
            'result' => new RandomFoxResult([]),
        ]);
        [, $err] = RandomFoxMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RandomFoxSpec(['step' => 's']),
            'response' => new RandomFoxResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RandomFoxResult([]),
        ]);
        [, $err] = RandomFoxMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RandomFoxSpec(['step' => 's']),
            'response' => new RandomFoxResponse(self::resp(200, ['v' => 1])),
            'result' => new RandomFoxResult([]),
        ]);
        [, $err] = RandomFoxMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RandomFoxSpec(['step' => 's']),
            'response' => new RandomFoxResponse(self::resp(200, ['v' => 2])),
            'result' => new RandomFoxResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RandomFoxMakeResponse::call($ctx);
    ...
    {
        $preset = new RandomFoxResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RandomFoxSpec([]),
            'response' => new RandomFoxResponse([]),
            'result' => new RandomFoxResult([]),
        ...
        [$got, $err] = RandomFoxMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RandomFoxResult([])]);
        [, $err] = RandomFoxMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RandomFoxSpec([]), 'result' => null]);
        [, $err] = RandomFoxMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RandomFoxSpec(['step' => 's']),
            'result' => new RandomFoxResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RandomFoxOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RandomFoxMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RandomFoxSpec(['step' => 's']),
            'result' => new RandomFoxResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RandomFoxOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RandomFoxMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RandomFoxResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RandomFoxSpec([]),
            'result' => new RandomFoxResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RandomFoxMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RandomFoxMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RandomFoxError('boom', 'boom');
        $utility->fetcher = function (RandomFoxContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RandomFoxSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RandomFoxMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RandomFoxContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RandomFoxMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RandomFoxResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RandomFoxContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RandomFoxSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RandomFoxMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RandomFoxResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RandomFoxSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RandomFoxMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RandomFoxMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RandomFoxMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RandomFoxResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RandomFoxDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RandomFoxResult(['ok' => false])]);
        $this->expectException(RandomFoxError::class);
        RandomFoxDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RandomFoxResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RandomFoxMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RandomFoxMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RandomFoxBaseFeature();
        $b = new RandomFoxBaseFeature();
        RandomFoxFeatureAdd::call($ctx, $a);
        RandomFoxFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RandomFoxBaseFeature
    {
        $f = new RandomFoxBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RandomFoxFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RandomFoxContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RandomFoxSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RandomFoxPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RandomFoxResponse(['headers' => null]),
            'result' => new RandomFoxResult([]),
        ]);
        RandomFoxResultHeaders::call($ctx);
