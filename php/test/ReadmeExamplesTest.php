...
// RandomFox SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RandomFoxSDK::test)
...
{
    private const SDK_CLASS = 'RandomFoxSDK';
    ...
    private const SDK_BASE = 'randomfox_sdk';
