...
class RandomFoxProxyFeature extends RandomFoxBaseFeature
{
    ...
    public function init(RandomFoxContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RandomFoxContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
