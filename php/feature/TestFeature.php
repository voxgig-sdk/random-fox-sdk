...
// RandomFox SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RandomFoxTestFeature extends RandomFoxBaseFeature
{
    ...
    public function init(RandomFoxContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RandomFoxContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RandomFoxParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RandomFoxContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RandomFoxContext $ctx, $op, $args): array
    {
