...
from randomfox_sdk.core.control import RandomFoxControl
...
from randomfox_sdk.core.helpers import get_ctx_prop, to_map
...
class RandomFoxContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, RandomFoxSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RandomFoxResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RandomFoxResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RandomFoxError(code, msg, self)
