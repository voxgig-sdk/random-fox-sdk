...
from randomfox_sdk.utility import register

# Load features
from randomfox_sdk.feature.base_feature import RandomFoxBaseFeature
from randomfox_sdk.features import _has_feature, _make_feature
...
class RandomFoxSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RandomFoxUtility()
        self._utility = utility

        from randomfox_sdk.config import shared_config
    ...
    def get_utility(self):
        return RandomFoxUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RandomFoxSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Fox(self, data=None) -> "FoxEntity":
        ...
        from randomfox_sdk.entity.fox_entity import FoxEntity
