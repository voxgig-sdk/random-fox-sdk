...
class RandomFoxTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RandomFoxTestRunner.getenv("RANDOMFOX_TEST_LIVE")
        override = RandomFoxTestRunner.getenv("RANDOMFOX_TEST_OVERRIDE")
        ...
        explain = RandomFoxTestRunner.getenv("RANDOMFOX_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["RANDOMFOX_TEST_EXPLAIN"] = explain
