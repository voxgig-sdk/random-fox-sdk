...
from randomfox_sdk.utility.voxgig_struct import voxgig_struct as vs
from randomfox_sdk import RandomFoxSDK
from randomfox_sdk.core.spec import RandomFoxSpec
from randomfox_sdk.core.result import RandomFoxResult
from randomfox_sdk.core.response import RandomFoxResponse
from randomfox_sdk.core.operation import RandomFoxOperation
from randomfox_sdk.core.error import RandomFoxError
from randomfox_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return RandomFoxError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = RandomFoxSDK.test(None, None)
        ...
        class TestInitFeature(RandomFoxBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RandomFoxBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RandomFoxSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RandomFoxSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RandomFoxSDK.test(None, setup_opts)
