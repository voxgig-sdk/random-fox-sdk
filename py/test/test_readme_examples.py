# RandomFox SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RandomFoxSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RandomFoxSDK(...) and RandomFoxSDK.test(...) become
#      RandomFoxSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "randomfox_sdk"
_SDK_CLASS = "RandomFoxSDK"
