...
type Args struct {
	Entity string         `json:"entity" jsonschema:"fox"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RandomFoxSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "random-fox_list",
		Description: "List records from RandomFox. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "random-fox_load",
		Description: "Load a single record from RandomFox. " +
...
func runOp(client *sdk.RandomFoxSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RandomFoxSDK, name string) (sdk.RandomFoxEntity, error) {
	switch strings.ToLower(name) {
	case "fox":
		return client.Fox(nil), nil
