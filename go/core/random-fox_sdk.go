...
func (sdk *RandomFoxSDK) OptionsMap() map[string]any {
...
func (sdk *RandomFoxSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RandomFoxSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RandomFoxSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RandomFoxSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RandomFoxSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RandomFoxSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RandomFoxSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RandomFoxSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RandomFoxSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RandomFoxSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
