...
func NewFoxEntity(client *core.RandomFoxSDK, entopts map[string]any) *FoxEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FoxEntity) GetName() string { return e.name }
...
func (e *FoxEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FoxEntity) Deleted() bool {
	return e.deleted
}


func (e *FoxEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFoxEntity(e.client, opts)
}

func (e *FoxEntity) Data(args ...any) any {
...
func (e *FoxEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Fox; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FoxEntity) DataTyped(data ...Fox) Fox {
	if len(data) > 0 {
		return typedFrom[Fox](e.Data(asMap(data[0])))
	}
	return typedFrom[Fox](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Fox (all fields
// optional at the wire level).
func (e *FoxEntity) MatchTyped(match ...Fox) Fox {
	if len(match) > 0 {
		return typedFrom[Fox](e.Match(asMap(match[0])))
	}
	return typedFrom[Fox](e.Match())
}
...
func (e *FoxEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FoxEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FoxLoadMatch and returns an Fox. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FoxEntity) LoadTyped(reqmatch FoxLoadMatch, ctrl map[string]any) (Fox, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Fox{}, err
	}
	return typedFrom[Fox](res), nil
}



func (e *FoxEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FoxEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FoxEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FoxEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FoxEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
