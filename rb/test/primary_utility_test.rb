...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = RandomFoxOmni.make_runner(TEST_JSON_FILE, RandomFoxSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : RandomFoxOmni.errify(err)
    end
