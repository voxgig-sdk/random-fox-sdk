...
function envOverride(m) {
    if ('TRUE' === process.env.RANDOM_FOX_TEST_LIVE ||
        'TRUE' === process.env.RANDOM_FOX_TEST_OVERRIDE) {
    ...
    m.RANDOM_FOX_TEST_EXPLAIN = process.env.RANDOM_FOX_TEST_EXPLAIN || m.RANDOM_FOX_TEST_EXPLAIN;
    return m;
}
