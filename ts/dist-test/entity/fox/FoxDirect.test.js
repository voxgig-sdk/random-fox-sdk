...
(0, node_test_1.describe)('FoxDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RandomFoxSDK({
    ...
    (0, node_test_1.test)('direct-load-fox', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-fox', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.RANDOM_FOX_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RandomFoxSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['RANDOM_FOX_TEST_FOX_ENTID'];
    ...
    const client = new __1.RandomFoxSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=FoxDirect.test.js.map