...
describe("FoxDirect", function()
  it("should direct-load-fox", function()
    local setup = fox_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-fox", setup.live and "live" or "unit")
